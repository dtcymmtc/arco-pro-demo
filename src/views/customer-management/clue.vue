<template>
  <div class="container">
    <Breadcrumb :items="['menu.customerManagement', 'menu.customerManagement.clue']" />
    <a-row :gutter="20" align="stretch">
      <a-col :span="24">
        <a-card class="general-card" :title="$t('menu.customerManagement.clue')">
...
const filterData = [
  ...
  },
  {
    ...
    dataSource: [
      ...
      { label: '腾讯', value: 'key8' },
      { label: '直播', value: 'key9' },
      { label: '小红书', value: 'key10' },
      { label: '欧盟技术', value: 'key11' },
      { label: '日本技术', value: 'key12' },
    ],
  },
  {
    label: '所属部门',
